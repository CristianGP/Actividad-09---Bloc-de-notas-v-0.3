...
public class ModelBlocDeNotas extends javax.swing.JPanel {
    ...
    public ModelBlocDeNotas () {
        this.setSize(675,500);
    }
    @Override
    public void paint(Graphics g) {
        Dimension tam = getSize();
        ImageIcon Img = new ImageIcon(getClass().getResource("/Componentes/descarga.jpg"));
